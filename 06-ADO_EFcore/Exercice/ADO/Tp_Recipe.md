...
- Notre application gerera des recettes qui contiendront des ingrédients des étapes des commentaires et qui seront associées à une catégorie, tout ses elements seront stockés en base de donnée grace a ADO
