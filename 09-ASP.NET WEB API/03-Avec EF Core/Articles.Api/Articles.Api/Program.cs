...
// cree un bloc qui sera automatiquement nettoyé à la fin
// S'assurer que la bdd est pretes
// Ajouter des données de test si la base est vide
using(var scope = app.Services.CreateScope())
{
    // Donne moi une instance de applicationdbcontext
    // C'est le systeme d'injection de dépendance de asp.net qui cree l'instance
    var context = scope.ServiceProvider.GetRequiredService<ApplicationDbContext>();

    // On appelle notre methode d'initialisation avec le contexte
    // C'est elle qui va créer les données de test si necessaire
